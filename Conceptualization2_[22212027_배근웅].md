...
## 6. Reference 
본 프로젝트의 설계 및 구현 과정에서 활용한 기술 표준, 가이드라인 및 시각 자료 출처는 다음과 같습니다.

### 기술 문서 및 API 레퍼런스
* **JAVA Language GUI**: Java SE 7 API 및 Swing/AWT 컴포넌트 라이브러리 문서 참고
    * [Oracle Java SE 7 Documentation](http://www.oracle.com/technetwork/java/javase/documentation/java-se-7-doc-download-435117.html)
* **Google Gemini API**: AI 분석 로직 구현을 위한 프롬프트 엔지니어링 및 모델 활용 가이드 준수

### 설계 방법론 및 도구
* **Use Case Diagram 사용법**: 액터와 시스템 간의 상호작용 정의 및 관계 설계 방법론 참고
    * [Visual Paradigm: Use Case Diagram Tutorial](https://www.visual-paradigm.com/solution/usecase/usecase/)
* **UML Modeling**: `AnalysisManager`, `LoginVerificationManager` 등 시스템 클래스 구조 설계 원칙 적용

### 시각 자료 및 오픈 소스 출처
* **각종 그림 및 아이콘**: 대시보드 UI 및 시스템 아이콘 제작을 위한 저작권 프리 이미지 활용
    * [Pixabay (Royalty-Free Images)](https://pixabay.com/)
* **UI Framework**: 금융 데이터 시각화를 위한 차트 레이아웃 및 폰트 라이브러리 가이드 참고
